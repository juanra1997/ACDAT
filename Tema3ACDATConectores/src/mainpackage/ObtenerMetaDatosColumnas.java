 ...
 * @author Juanra
 */
public class ObtenerMetaDatosColumnas {
    ...
    //Creamos el objeto que nos va a permitir obtener los datos;
    static ResultSetMetaData rsmd;
    //Creamos las variables necesarias
    static String nula=null;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //Obtenemos los datos y los guardamos
            rsmd = result.getMetaData();
            //Obtenemos el numero de columnas que nos devuelve la consulta
            int nColumnas = rsmd.getColumnCount();
            System.out.println("Número de columnas devueltas por la consulta: " + nColumnas);
            for (int i = 1; i <= nColumnas; i++) {
                ...
                //Obtenemos el tamaño maximo de introduccion
